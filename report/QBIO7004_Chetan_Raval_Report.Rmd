...
```
In this context, the propensity function calculates the rate at which each reaction in the system can occur given the current state of the system at that point in time in relation to the parameters. This function calculates the rates of all possible events in the model such as protein folding, misfolding, degradation, and negative feedback.

### 2.1 Assumptions and Simplifications

- environmental conditions (pH and temperature)
- protein stability (delta G)
- chaperone type and function
- other degradation pathways - Ubiquitin-Proteasome Pathway and Lysosomal Proteolysis
- post-translational modifications
- protein folding/misfolding mechanisms outside of my knowledge
