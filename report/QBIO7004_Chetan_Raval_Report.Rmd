...
To determine the system parameters that cause the highest fraction of protein misfolding, the results vector was inspected and a new vector was created with fractions of misfolding rates for each simulation. The maximum value from this list was then extracted along with the parameters utilised in that particular simulation.
```{r}
